import thaisImg from "../../assets/images/contadora-thais.jpeg"

export function Thais() {
  return (
    <section
      id="thais"
      className="bg-white py-36 scroll-mt-24 overflow-hidden"
    >
      <div className="mx-auto max-w-7xl px-6 grid items-center gap-12 md:grid-cols-2">
        ...
        <div className="z-10">
          ...
          <p className="mt-6 text-slate-600 leading-relaxed">
            Profissional com atuação focada em contabilidade empresarial e fiscal,
            oferecendo soluções estratégicas para empresas que buscam crescimento
            com segurança e organização.
          </p>

          <p className="mt-4 text-slate-600 leading-relaxed">
            Atua com transparência, compromisso e proximidade com seus clientes,
            garantindo decisões contábeis mais seguras e eficientes.
          </p>
        ...
        <div className="relative flex justify-end">
          ...
          {/* efeito de destaque atrás */}
          <div className="absolute -right-10 top-10 -z-10 h-72 w-72 rounded-full bg-blue-100 blur-3xl" />
        </div>
